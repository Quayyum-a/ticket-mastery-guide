...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Official FIFA World Cup 2026 ticketing platform. Browse matches, select your seats, and secure your tickets with Bitcoin payment." },
      { property: "og:title", content: "FIFA World Cup 26™ Official Ticketing" },
      { property: "og:description", content: "Official ticketing for FIFA World Cup 2026. Secure your seats now." },
